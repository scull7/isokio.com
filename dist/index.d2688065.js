...
})({"PiYXr":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 61575;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "121587e72abfe7568d131b9ad2688065";
// @flow
...
},{}],"1aOmI":[function(require,module,exports) {
var _MainElm = require('../Main.elm');
const _app = _MainElm.Elm.Main.init({
  flags: {
    test: 0
  }
});

},{"../Main.elm":"dQUqP"}],"dQUqP":[function(require,module,exports) {
(function(scope){
'use strict';
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A2($author$project$Main$Model, key, $author$project$Main$Home),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Nav$navLinks = _List_fromArray(
	[
		{display: 'Home', location: '#'},
		{display: 'Font Explorer', location: '#'}
	]);
var $author$project$Nav$viewLink = function (link) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href(link.location)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(link.display)
					]))
			]));
};
var $author$project$Nav$view = A2(
	$elm$html$Html$nav,
	_List_Nil,
	_List_fromArray(
		[
			...
			$elm$html$Html$ul,
			_List_Nil,
			A2($elm$core$List$map, $author$project$Nav$viewLink, $author$project$Nav$navLinks))
		]));
...
var $author$project$Main$viewHeader = function (model) {
	return A2(
		...
		_List_Nil,
		_List_fromArray(
			[$author$project$Main$viewBrand, $author$project$Nav$view]));
};
...
},{}]},["PiYXr","1aOmI"], "1aOmI", "parcelRequireeb41")

//# sourceMappingURL=index.d2688065.js.map
